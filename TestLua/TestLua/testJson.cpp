...
printf(MD5("abcxxxxxxxxxxxxxxxxxxxxfdsafdsafsddddddddddddddddddxxxxxxxxxxxxx11111111111111edddddddddd").toString().c_str());
printf("\n");
printf(MD5("xxxxxxxxxxxxxxxx").toString().c_str());
printf("\n");
printf(MD5("xxxxxxxxxxxxxxxx").toString().c_str());
	return 1;
}
