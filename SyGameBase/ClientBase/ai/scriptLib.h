...
namespace script{
	...
	struct CalcVar{
        ...
        struct Lib:public tixmlCode{
             ...
             * \param name 变量名字
             **/
			void clearVar(TEMPSTUB *stub,const std::string &name)
            {
             ...
             **/
            void addCodeVar(TEMPSTUB *stub,std::string name,std::string value,ScopeType scope,unsigned char timeType,tixmlCodeNode * temp)
            {
        ...
        public:
			...
			virtual bool execCode(TEMPSTUB *commonStub,tixmlCodeNode *temp)
			{
            ...
            virtual bool execCode(TEMPSTUB *commonStub,const char*name)
            {
                ...
                return execCode(commonStub,temp);
            }
			tixmlCodeNode* findCode(const char *name)
			{
				CODES_ITER iter = codes.find(name);
                tixmlCodeNode * temp = NULL;
                if (iter != codes.end())
            ...
            int var(TEMPSTUB *stub,script::tixmlCodeNode * node)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        unsigned char time = script::Var::FOROVER;
